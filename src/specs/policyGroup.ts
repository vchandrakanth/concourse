...
describe('Creaing Policy Group Concourse ', async function () {
  ...
  it('Step 7: Creating Policy Group with  Published', async function (): Promise<any> {
    ...
    await policyPage.createPolicyGroup(baseSurface, policyGroupNamePublish, policyGroupDescPublish, 'E2E Admin', 'PUBLISHED', policyGroupTemplateName, attributeTagName, services, ' ', ' ', ' ', 'Allowed AWS Products in Stacks 1');
