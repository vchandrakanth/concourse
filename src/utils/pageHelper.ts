...
import { UtilMath } from './utilsMath';
...
export class PageHelper {
    ...
    static DEFAULT_TIMEOUT = PageHelper.timeout.xxxl;
    ...
    static async sendKeysToInputField(elem: ElementFinder, key: string) {
        await WaitHelper.waitForElementToBeEnabled(elem);
    ...
    public static async getAllTextsInArray(elements: ElementArrayFinder) {
        ...
        return UtilMath.cleanArray(allTexts);
    }
