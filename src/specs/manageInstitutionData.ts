...
describe('Surface Creation Concourse ', async function () {
    ...
    let publicKeys = properties.SurfaceData.dataForPublicKeys;
    ...
    // it('Step 3: Create Network Whitelists Data For Institution', async function (): Promise<any> {
    ...
    it('Step 4: CreatePublic Keys Data For Institution', async function (): Promise<any> {
