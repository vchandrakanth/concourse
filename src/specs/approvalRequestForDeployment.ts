...
describe('Policy Group Concourse ', async function () {
    ...
    it('Step 7: Verify Approval Request For Publish', async function (): Promise<any> {
        await approvals.VerifyPublishedApprovalRequest(baseSurface, deploymentId);
    ...
    it('Step 8: Approve Publish Request', async function (): Promise<any> {
        await approvals.ApprovalAction(baseSurface, deploymentId);
    });
    ...
    it('Step 10: Verify Approval Request For Delete', async function (): Promise<any> {
        await approvals.VerifyDeleteApprovalRequest(baseSurface, deploymentId);
        // await ExpectHelper.isListElementExists(approvals.approvalList, deploymentId);
    });
