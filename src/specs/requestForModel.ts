...
describe('Request For Model ', async function () {
    ...
    it('Step 3: Creating Policy Group', async function (): Promise<any> {
        await policyPage.createPolicyGroup(baseSurface, policyGroupName, policyGroupDesc, 'E2E Admin', 'PUBLISHED', policyGroupTemplateName, attributeTagName, services, 'Default Surface - Root Surface Layer', 'MODEL', 'E2E Admin', 'Require Approval of Institutional Entities 1');
    ...
    it('Step 6: Create New Enclave Model', async function (): Promise<any> {
    ...
    it('Step 9: Delete Enclave Model', async function (): Promise<any> {
